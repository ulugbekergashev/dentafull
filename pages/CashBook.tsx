                                ...
                                <table className="w-full text-sm">
                                    ...
                                    <tfoot className="bg-gray-50 dark:bg-gray-700 border-t-2 border-gray-200 dark:border-gray-600">
                                        <tr>
                                            ...
                                            {doctorCols.map(col => (
                                                <td key={col.id} className="px-3 py-3 text-right font-black text-gray-900 dark:text-white tabular-nums sticky bottom-0 bg-gray-50 dark:bg-gray-700 z-20">
                                                    {col.total ? num(col.total) : '—'}
                                                </td>
                                            ))}
                                            <td className="px-3 py-3 text-right font-black text-emerald-600 dark:text-emerald-400 tabular-nums whitespace-nowrap sticky bottom-0 bg-gray-50 dark:bg-gray-700 z-20">
                            ...
                            <tfoot className="bg-gray-50 dark:bg-gray-700 border-t-2 border-gray-200 dark:border-gray-600">
                                <tr>
                                    ...
                                    {doctorCols.map(col => {
                                        ...
                                        return (
                                            <td key={col.id} className="px-3 py-3 text-right font-black tabular-nums text-gray-900 dark:text-white sticky bottom-0 bg-gray-50 dark:bg-gray-700 z-20">
                                                {total ? num(total) : '—'}
                                            </td>
                                        );
                                    })}
