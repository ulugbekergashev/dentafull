...
export default function DemoRequestModal({ isOpen, onClose }: DemoRequestModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg z-10 rounded-3xl overflow-hidden shadow-2xl shadow-blue-900/30">

        {/* Header */}
        <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 px-8 pt-8 pb-12 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-2">
            <span className="text-[10px] font-black text-blue-200 uppercase tracking-[0.2em]">DentaCRM · 7 kun bepul</span>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm font-bold text-gray-700">
                  <User className="w-4 h-4 text-blue-500" /> Ism-familiya
                </label>
                <input
                  type="text"
                  required
                  ...
                  value={form.name}
                  onChange={set("name")}
                  className="w-full bg-gray-50 border-2 border-gray-100 focus:border-blue-500 focus:bg-white rounded-2xl px-5 py-4 text-base text-gray-800 placeholder:text-gray-300 outline-none transition-all"
                />
              </div>

              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm font-bold text-gray-700">
                  <Building2 className="w-4 h-4 text-blue-500" /> Klinika nomi
                </label>
                <input
                  type="text"
                  required
              ...
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-sm font-bold text-gray-700">
                  <Phone className="w-4 h-4 text-blue-500" /> Telefon raqam
                </label>
                <input
                  type="text"
                  required
                  ...
                  value={form.phone}
                  onChange={set("phone")}
                  className="w-full bg-gray-50 border-2 border-gray-100 focus:border-blue-500 focus:bg-white rounded-2xl px-5 py-4 text-base text-gray-800 font-mono placeholder:text-gray-300 outline-none transition-all"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-base tracking-wide transition-all active:scale-[0.98] cursor-pointer shadow-xl shadow-blue-500/25"
              >
            ...
            <div className="text-center py-10 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-base text-gray-500 leading-relaxed">
                  ...
                  <span className="font-bold text-blue-600">{form.phone}</span> orqali 15 daqiqada bog'lanamiz.
                </p>
              </div>
              <button
                onClick={handleClose}
