...
const RealisticTooth: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div className="w-12 h-16 sm:w-14 sm:h-20 relative filter drop-shadow-lg transition-all duration-300">
...
export const TeethChart: React.FC<TeethChartProps> = ({ initialData = [], readOnly = false }) => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
      ...
      {/* Chart Container */}
      <div className="flex flex-col items-center gap-8 overflow-x-auto pb-4 select-none bg-gradient-to-b from-gray-50/50 to-white dark:from-gray-800/50 dark:to-gray-900 rounded-3xl p-6 border border-gray-100 dark:border-gray-700/50">
        
        {/* Upper Jaw */}
        <div className="relative">
            <div className="text-center text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">Yuqori Jag'</div>
        ...
        <div className="relative w-full flex flex-col items-center">
            ...
            <div className="text-center text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">Pastki Jag'</div>
            <div className="flex gap-1 sm:gap-2 justify-center px-2">
